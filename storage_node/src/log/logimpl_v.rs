...
verus! {
    ...
    impl UntrustedLogImpl
    {
        ...
        pub closed spec fn inv<Perm, ID, WRPMRegion>(
            &self,
        ...
        pub proof fn lemma_inv_implies_wrpm_inv<Perm, ID, WRPMRegion>(
            &self,
            wrpm_region: &WRPMRegion,
            log_id: u128
        )
        ...
        pub proof fn lemma_inv_implies_can_only_crash_as<Perm, ID, WRPMRegion>(
            &self,
            wrpm_region: &WRPMRegion,
            log_id: u128
        )
        ...
        pub exec fn start<WRPMRegion>(
            ...
            where
                WRPMRegion: WriteRestrictedPersistentMemoryRegionTrait<TrustedPermission, LogInvParam>
            requires
                ...
                }
        {
            ...
            proof {
                ...
                lemma_invariants_imply_crash_recover_forall(wrpm_region@, log_id, cdb, info, state);
                ...
                lemma_metadata_set_after_crash(wrpm_region@, cdb);
            }
        ...
        exec fn tentatively_append_to_log<WRPMRegion>(
            &self,
            wrpm_region: &mut WRPMRegion,
        ...
        pub exec fn tentatively_append<WRPMRegion>(
            &mut self,
            wrpm_region: &mut WRPMRegion,
            bytes_to_append: &[u8],
        ...
        exec fn update_inactive_log_metadata<WRPMRegion>(
            &self,
            wrpm_region: &mut WRPMRegion,
            subregion: &WriteRestrictedPersistentMemorySubregion,
            Ghost(log_id): Ghost<u128>,
        ...
        exec fn update_log_metadata<WRPMRegion>(
            &mut self,
            wrpm_region: &mut WRPMRegion,
            Ghost(log_id): Ghost<u128>,
            Ghost(prev_info): Ghost<LogInfo>,
        ...
        // appends.
        pub exec fn advance_head<WRPMRegion>(
            &mut self,
            wrpm_region: &mut WRPMRegion,
            new_head: u128,
            Ghost(log_id): Ghost<u128>,
        ...
        pub exec fn read<Perm, ID, WRPMRegion>(
            &self,
            wrpm_region: &WRPMRegion,
            pos: u128,
            len: u64,
        ...
        pub exec fn get_head_tail_and_capacity<Perm, ID, WRPMRegion>(
            &self,
            wrpm_region: &WRPMRegion,
            Ghost(log_id): Ghost<u128>,
